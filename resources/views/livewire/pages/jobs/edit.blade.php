    ...
    <div class="container mx-auto py-4">
        ...
        <form wire:submit.prevent="update">
            <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="bg-white border dark:bg-gray-800 shadow sm:rounded-lg p-4 space-y-4">
                        ...
                        <div class="flex w-full space-x-4">
                            <div class="flex flex-col space-y-2 w-1/2">
                                ...
                                <input type="text" id="experience" class="rounded-lg border border-gray-300" wire:model="experience" placeholder="Eg. 1-2 Yrs" />
                                @error('experience')
                                    <span class="text-xs text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="flex flex-col space-y-2 w-1/2">
                                ...
                                <input type="text" id="salary" class="rounded-lg border border-gray-300" wire:model="salary" placeholder="Eg. 4-5 Lacs PA" />
                                @error('salary')
                                    <span class="text-xs text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="flex w-full space-x-4">
                            <div class="flex flex-col space-y-2 w-1/2">
                                ...
                                <input type="text" id="location" class="rounded-lg border border-gray-300" wire:model="location" placeholder="Eg. Remote / Pune" />
                                @error('location')
                                    <span class="text-xs text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="flex flex-col space-y-2 w-1/2">
                                ...
                                <input type="text" id="extra_info" class="rounded-lg border border-gray-300" wire:model="extra_info" placeholder="Eg. Full Time/ Part Time, Flexible" />
                                @error('extra_info')
                                    <span class="text-xs text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="col-span-4 space-y-4">
                    <div class="bg-white border dark:bg-gray-800 shadow sm:rounded-lg p-4 space-y-4">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <input type="text" id="company_name" class="rounded-lg border border-gray-300" wire:model="company_name" placeholder="Company Name" />
                            @error('company_name')
                                <span class="text-xs text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="flex flex-col space-y-2">
                            ...
                            @if($job->logo)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $job->logo) }}" alt="Company Logo" class="h-20">
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                <button class="mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="submit">Update</button>
            </div>
        </form>
    </div>
</div>
